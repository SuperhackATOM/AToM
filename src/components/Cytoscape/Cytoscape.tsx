...
const Cytoscape = () => {
  ...
  const data = [
    ...
    { data: { source: "0x03", target: "0x00" } },
    { data: { source: "0x03", target: "0x05" } },
    { data: { source: "0x02", target: "0x00" } },
    { data: { source: "0x00", target: "0x07" } },
    { data: { source: "0x00", target: "0x08" } },
    { data: { source: "0x00", target: "0x04" } },
    { data: { source: "0x04", target: "0x06" } },
  ];
